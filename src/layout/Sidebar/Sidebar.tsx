...
export const AppSidebar: React.FC<SidebarProps> = (props): JSX.Element => {
    ...
    const checkRoute = (): boolean => {
        ...
        const sidebarEnabledRoutes = ['analysisPage', 'details', 'user', 'profile', 'graduates', 'addingGraduates', 'addingTranscript', 'ai-chat', 'my-diplomas', 'applications', 'employer'];
                            ...
                            <Box sx={{height: '100%'}}>
                                ...
                                <Box sx={{
                                    ...
                                    <Box display="flex" height="100%" justifyContent="start"
                                        ...
                                        >
                                            <Box display='flex' width='100%' flexBasis='1' flexWrap={'wrap'}
                                                 justifyContent='center'>

                                                <Typography textAlign='center' mb={".5rem"} id="modal-modal-title"
                                                            fontSize='1.2rem'
                                                            fontWeight='600'
                                                >
