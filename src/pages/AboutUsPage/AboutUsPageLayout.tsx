...
export const AboutUsPageLayout: React.FC = () => {
    ...
    return (
        <Box>
            ...
            <Box display="flex" justifyContent="space-between" width="100%" mt="9rem" pb="10rem" px="18rem">
                <Box display="flex" flexDirection="column" width="45%" justifyContent="space-between">
                    <Box>
                        <Typography fontSize="2rem" fontWeight="600" color="#2D2D2D">
                            Контакты
                        </Typography>
                        <Typography fontSize=".9rem" color="#818181" whiteSpace="pre-line">
                    ...
                    <Box>
                        ...
                        <Box mt="2rem" display="flex" gap="1rem" flexDirection="row">
                            ...
                            <Typography fontSize=".9rem" color="#818181">
                                twitter
                            </Typography>
                            <Typography fontSize=".9rem" color="#818181">
                                instagram
