...
const SettingsPage: React.FC = () => {
    ...
    return (
        <Box display="flex" flexDirection="row" sx={{backgroundColor: '#FAFBFF', minHeight: "100vh", padding: '20px'}}>
            ...
            <Box display="flex" flexDirection="column">
                ...
                <Container sx={{
                    ...
                    <FormControl
                        sx={{width: '200px', marginLeft: '30px', backgroundColor: '#F8F8F8', borderRadius: '30px',}}>
                        <InputLabel id="demo-simple-select-helper-label">Age</InputLabel>
                        <Select
                            labelId="demo-simple-select-helper-label"
                            id="demo-simple-select-helper"
