...
import { Box, Card, CardMedia, Typography, useMediaQuery, Divider, CardContent, Menu, MenuItem, Skeleton } from '@mui/material';
					...
					<Box display='flex' flexDirection='column' sx={{ backgroundColor: 'white', borderRadius: '15px', }}>
						<Box px="1rem" sx={{
								...
								{imageLoaded ? (
									<CardMedia
										...
										onError={() => {
											...
											setImageLoaded(true); // Mark as loaded even on error to hide the skeleton
										}}
									/>
								) : (
							...
							<Box margin="1rem" sx={{
								...
								<Typography style={{ cursor: "pointer" }} className={styles.textMd} fontWeight='600'
									...
									<ExpandMore
										style={{ marginLeft: ".2rem", transform: showFull ? "rotate(180deg)" : "" }} />
								</Typography>
							</Box>
							<Box margin="1rem" sx={{
								'@media (max-width: 778px)': {
